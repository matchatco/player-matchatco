$('#webcastx').click(function() {
if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){srcx}
else{location.href="wvc-x-callback://open?url="+srcx+"&secure_uri=true"}
});
$("#reportx").click(function() {
var doc;
var result = confirm(message1report)
if (result == true) {
const myTimeout = setTimeout(myGreeting, 2000);
function myGreeting() {
alert(message2report)
var message = "بلاغ جديد يخص ";
$.get("https://api.telegram.org/bot"+tokent+"/sendMessage?text="+message+"("+namechannel+")&chat_id="+user_id);
}} else {}
});
$("#cscreend").click(function() {
$("#cscreenf").show();
$("#cscreend").hide();
$("video").css("object-fit","contain");});
$("#cscreenf").click(function() {
$("#cscreend").show();
$("#cscreenf").hide();
